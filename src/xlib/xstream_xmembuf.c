...
static xstream_ops_t xstream_xmembuf_ops = {
    .op_open  = &xstream_xmembuf_open_fn,
    .op_write = &xstream_xmembuf_write_fn,
    .op_read  = &xstream_xmembuf_read_fn,
    .op_close = &xstream_xmembuf_close_fn,
    .op_flush = &xstream_xmembuf_flush_fn,
};
